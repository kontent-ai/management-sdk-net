...
namespace KenticoCloud.ContentManagement.Tests
{
    public class TestUtils
    {
        ...
        internal static async Task<ContentItemVariantModel> PrepareVariantToDelete(string languageCodename, object elements, ContentItemModel item)
        {
            ...
            var variantUpdateModel = new ContentItemVariantUpdateModel() { Elements = elements };
