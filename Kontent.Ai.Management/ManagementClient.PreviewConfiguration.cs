...
public partial class ManagementClient
{
    ...
    {
        var response = await _managementApi.GetPreviewConfigurationInternalAsync(cancellationToken);
    ...
    {
        var response = await _managementApi.ModifyPreviewConfigurationInternalAsync(previewConfiguration, cancellationToken);
        return await response.ToManagementResultAsync();
    }
}
