...
internal partial interface IManagementApi
{
    ...
    /// <param name="itemIdentifier">The content item identifier path segment (see <see cref="ReferenceUrlExtensions.ToUrlSegment"/>).</param>
    ...
    /// <param name="typeIdentifier">The content type identifier path segment (see <see cref="ReferenceUrlExtensions.ToUrlSegment"/>).</param>
    ...
    /// <param name="collectionIdentifier">The collection identifier path segment (see <see cref="ReferenceUrlExtensions.ToUrlSegment"/>).</param>
    /// <param name="continuationToken">Continuation token from a previous page's response; <c>null</c> for the first page.</param>
    /// <param name="cancellationToken">Token to cancel the request.</param>
    ...
    /// <param name="spaceIdentifier">The space identifier path segment (see <see cref="ReferenceUrlExtensions.ToUrlSegment"/>).</param>
    /// <param name="continuationToken">Continuation token from a previous page's response; <c>null</c> for the first page.</param>
    /// <param name="cancellationToken">Token to cancel the request.</param>
