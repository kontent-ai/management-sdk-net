...
/// <summary>
/// <c>move</c> operation. Moves the object at <see cref="ContentTypeOperationBaseModel.Path"/> to a new position. The API requires exactly one of <see cref="Before"/> or <see cref="After"/>; sending neither (or both) returns 400.
/// </summary>
