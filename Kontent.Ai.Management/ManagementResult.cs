...
internal sealed class ManagementResult : IManagementResult
{
    ...
    public static ManagementResult Success(HttpStatusCode statusCode, string? requestUrl = null) =>
        new(true, null, statusCode, requestUrl);

    public static ManagementResult Failure(IError error, HttpStatusCode statusCode, string? requestUrl = null) =>
...
internal sealed class ManagementResult<T> : IManagementResult<T>
{
    ...
    public static ManagementResult<T> Success(T value, HttpStatusCode statusCode, string? requestUrl = null) =>
        new(true, value, null, statusCode, requestUrl);

    public static ManagementResult<T> Failure(IError error, HttpStatusCode statusCode, string? requestUrl = null) =>
