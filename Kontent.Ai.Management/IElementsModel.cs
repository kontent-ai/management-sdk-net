...
/// <c>model-generator-net</c>'s management mode implement this so the STJ envelope converter and strongly-typed
/// API methods can recognize them. Variant-level metadata lives on <c>LanguageVariantModel&lt;T&gt;</c>.
/// </summary>
