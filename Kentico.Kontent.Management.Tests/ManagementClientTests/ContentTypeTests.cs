...
public class ContentTypeTests
{
    ...
    [Fact]
    public async void GetContentTypeAsync_ById_GetsContentTypeAsync()
    {
        var client = _scenario
    ...
    [Fact]
    public async void GetContentTypeAsync_ByCodename_GetsContentTypeAsync()
    {
        var client = _scenario
            .WithResponses("ContentType.json")
            .CreateManagementClient();
    ...
    [Fact]
    public async void GetContentTypeAsync_ByExternalId_GetsContentTypeAsync()
    {
        var client = _scenario
            .WithResponses("ContentType.json")
            .CreateManagementClient();
    ...
    [Fact]
    public async void DeleteContentTypeAsync_ById_DeletesContentTypeAsync()
    {
        var client = _scenario.CreateManagementClient();
    ...
    [Fact]
    public async void DeleteContentTypeAsync_ByCodename_DeletesContentTypeAsync()
    {
        var client = _scenario.CreateManagementClient();
    ...
    [Fact]
    public async void DeleteContentTypeAsync_ByExternalId_DeletesContentTypeAsync()
    {
        var client = _scenario.CreateManagementClient();
